...
parser = argparse.ArgumentParser(description="UDP connection that can run in server and client mode")
        ...
        while True:
            try:
                ...
                if ack == expected_ack:
                    ...
                    # Send the packet
                    pack = struct.pack(header_format, seq, expected_ack + 1, headers.make_flags(0, 1, fin), window_size,
                                       0)
                    pack += message
                ...
                # Resend the packet
                repeat_send(clientSocket, serverAddress, pack)
